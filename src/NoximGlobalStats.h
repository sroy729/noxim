...
class NoximGlobalStats {
  ...
  public:
	...
	double getNiAverageDelay();//hfsken 120629
	double getNwAverageDelay();//hfsken 120629
	double getNwTotalAverageDelay();//hfsken 120629
	double getNiTotalAverageDelay();//hfsken 120629
	double getMsgTotalAverageDelay();//hfsken 120629
  ...
  private:
    const NoximNoC *noc;
	vector< int > router_buffer_delay;
	vector< int > ni_packet_delay;
	vector< int > ni_msg_delay;
};
