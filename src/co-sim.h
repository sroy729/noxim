...
//Initial temperature
#define INIT_TEMP	 358.15//363.15//363.15//367.15//298.15 //350.15//77 kalvin degree
#define INIT_TEMP_80 358 //353						//用來設定最上層(最熱)的溫度, 設高一點會比較快到達穩態, 節省模擬時間
//#define TEMP_THRESHOLD 94.2//70 
