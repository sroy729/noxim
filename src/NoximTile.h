...
SC_MODULE(NoximTile)
{
	...
	sc_in<int>         RCA_data_in[8]; //functional RCA port in this sim. (Jimmy added on 2012.06.27)
	sc_out<int>        RCA_data_out[8]; //functional RCA port in this sim. (Jimmy added on 2012.06.27)
	/*******RCA******/
    // NoP related I/O
