...
SC_MODULE(NoximVLink)
{
    ...
    sc_out <NoximFlit>  *flit_rx_to_UP;		// The input channels
    sc_out <bool>       *req_rx_to_UP ;		// The requests associated with the input channels
    sc_in  <bool>       *ack_rx_to_UP ;		// The outgoing ack signals associated with the input channels
    sc_in  <NoximFlit>  *flit_tx_to_UP;		// The input channels
    sc_in  <bool>       *req_tx_to_UP ;		// The requests associated with the input channels
    sc_out <bool>       *ack_tx_to_UP ;		// The outgoing ack signals associated with the input channels
	
    sc_in  <NoximFlit>  *flit_rx_to_DOWN;	// The output channels
    sc_in  <bool>       *req_rx_to_DOWN ;	// The requests associated with the output channels
    sc_out <bool>       *ack_rx_to_DOWN ;	// The outgoing ack signals associated with the output channels

	sc_out <NoximFlit>  *flit_tx_to_DOWN;	// The output channels
    sc_out <bool>       *req_tx_to_DOWN ;	// The requests associated with the output channels
    sc_in  <bool>       *ack_tx_to_DOWN ;	// The outgoing ack signals associated with the output channels
